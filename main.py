...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        self.pencil_button = tk.Button(self.holder, text="Pencil", width=15)
        self.pencil_button.grid(row=1, column=0)
        self.eraser_button = tk.Button(self.holder, text="Eraser", width=15)
        self.eraser_button.grid(row=2, column=0)
        self.color_button = tk.Button(self.holder, text="Select Color", width=15)
        ...
        self.new_button = tk.Button(self.holder, text="New", width=15)
        self.new_button.grid(row=1, column=1)
        self.clear_button = tk.Button(self.holder, text="Clear", width=15)
        self.clear_button.grid(row=2, column=1)
        self.exit_button = tk.Button(self.holder, text="Exit", width=15)
        ...
        self.default_button = tk.Button(self.holder, text="Default", width=15)
